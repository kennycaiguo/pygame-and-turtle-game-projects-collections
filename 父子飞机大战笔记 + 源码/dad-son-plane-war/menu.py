...
def main_menu(screen):
    #加载菜单音乐
    pg.mixer.music.load(sound_path + 'menu.ogg')
    #循环播放菜单音乐
    ...
    while True:
        ...
        if event.type == pg.KEYDOWN:
            ...
            pg.display.update()      
            # 加载ready音效     
    pg.mixer.music.load(sound_path + 'getready.ogg')
    #循环播放菜单音乐
    pg.mixer.music.play() 
    # ready = pg.mixer.Sound(sound_path + 'getready.ogg')
    # ready.play()
    screen.fill(BLACK)  
    funcs.draw_text(screen,"Get Ready!!!",40,WIDTH/2,HEIGHT/3)
    pg.display.update()
